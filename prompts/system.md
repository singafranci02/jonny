...
- KNOWLEDGE: excerpts from Francesco's own notes and documents, each tagged with its source file. Prefer answering from these over general knowledge, and mention the source file by name when you use one.
